...
var createProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, price, countInStock, category, files, urls, _i, files_1, file, path, result, err_1, product;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, price = _a.price, countInStock = _a.countInStock, category = _a.category;
                files = req.files;
                console.log(files);
                urls = [];
                _i = 0, files_1 = files;
            ...
            case 2:
                _b.trys.push([2, 4, , 5]);
                return [4 /*yield*/, cloudinary_1.default.v2.uploader.upload(path, {
                        resource_type: "auto",
                        use_filename: true,
            ...
            case 7:
                ...
                return [2 /*return*/, res.json({ status: "success", product: product })];
        }
    });
}); };
...
var getAllProducts = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var products, _a, category, gt, lt, price, _category;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                products = _b.sent();
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, prisma.product.findMany()];
            case 3:
                products = _b.sent();
