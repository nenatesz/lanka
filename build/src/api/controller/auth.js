...
exports.isAuthUser = exports.userLogin = exports.userRegister = void 0;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user.password = undefined;
                        token = jsonwebtoken_1.default.sign({ email: user.email, role: user.role, username: user.username }, config_1.default.jwt_secret, { expiresIn: "30d" });
