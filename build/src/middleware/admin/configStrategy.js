...
// CREATE ADMIN ACCOUNT USING PASSPORT CUSTOM STRATEGY
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                admin = _b.sent();
                if (!admin) {
                    return [2 /*return*/, done({ message: "Admin account already exists" }, false)];
                }
                console.log(admin);
...
// LOGIN ADMIN USING PASSPORT CUSTOM STRATEGY
passport_1.default.use("login-admin", new passport_local_1.default.Strategy({
    usernameField: "email",
    passwordField: "password",
    passReqToCallback: true,
}, function (req, email, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    var admin, isValidPassword, error_2;
