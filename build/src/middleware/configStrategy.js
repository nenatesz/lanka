...
passport_1.default.use("register", new CustomStrategy(function (req, done) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstName, email, password, lastName, username, role, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, firstName = _a.firstName, email = _a.email, password = _a.password, lastName = _a.lastName, username = _a.username, role = _a.role;
