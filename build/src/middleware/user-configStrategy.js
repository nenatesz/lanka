...
passport_1.default.use("register-user", new CustomStrategy(function (req, done) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstName, email, password, lastName, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, firstName = _a.firstName, email = _a.email, password = _a.password, lastName = _a.lastName;
            ...
            case 1:
                user = _b.sent();
                if (!user) {
                    return [2 /*return*/, done({ message: "Account already exists" }, false)];
                }
                console.log(user);
...
passport_1.default.use("login-user", new passport_local_1.default.Strategy({
    usernameField: "email",
    passwordField: "password",
    passReqToCallback: true,
}, function (req, email, password, done) { return __awaiter(void 0, void 0, void 0, function () {
    var user, isValidPassword, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, done(false, null, { message: "Invalid Login Details" })];
                }
...
passport_1.default.use(new passport_jwt_1.default.Strategy(opts, function (token, done) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma.adminUsers.findFirst({
                        where: {
                            AND: [
                                { email: {
                                        equals: email
            ...
            case 1:
                admin = _a.sent();
                if (!admin) {
                    return [2 /*return*/, done(null, false, { errors: { message: "User Not Authorized" } })];
                }
                // try {
                console.log(admin);
